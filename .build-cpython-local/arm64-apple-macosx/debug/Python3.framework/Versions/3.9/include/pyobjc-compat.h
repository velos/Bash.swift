...
#define PYOBJC_HAVE_FSREF 1
#define PYOBJC_HAVE_FSSPEC 1
#define PYOBJC_HAVE_NSARCHIVER 1
#define PYOBJC_HAVE_NSPORTCODER 1
#define PYOBJC_HAVE_NSCALENDARDATE 1
#define PYOBJC_HAVE_NSHOST 1
#define PYOBJC_HAVE_NSCONNECTIONDELEGATE 1
#define PYOBJC_HAVE_NSSPELLSERVERDELEGATE 1
#define PYOBJC_HAVE_NSURLDOWNLOADDELEGATE 1
#define PYOBJC_HAVE_NSURLHANDLECLIENT 1
#define PYOBJC_HAVE_NSUSERNOTIFICATIONCENTERDELEGATE 1
#define PYOBJC_HAVE_NSFILETYPEFORHFSTYPECODE 1
#endif
...
static inline CGFloat NSMaxX(NSRect aRect) {
    return (aRect.origin.x + aRect.size.width);
}
static inline CGFloat NSMaxY(NSRect aRect) {
    return (aRect.origin.y + aRect.size.height);
}
static inline CGFloat NSMidX(NSRect aRect) {
    return (aRect.origin.x + aRect.size.width * (CGFloat)0.5);
}
static inline CGFloat NSMidY(NSRect aRect) {
    return (aRect.origin.y + aRect.size.height * (CGFloat)0.5);
}
static inline CGFloat NSMinX(NSRect aRect) {
    return (aRect.origin.x);
}
static inline CGFloat NSMinY(NSRect aRect) {
    return (aRect.origin.y);
}
static inline CGFloat NSWidth(NSRect aRect) {
    return (aRect.size.width);
}

static inline CGFloat NSHeight(NSRect aRect) {
